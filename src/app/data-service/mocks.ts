...
*/
  ...
  static booknames = [
    ...
    "在咖啡冷掉之前",
    "我想吃掉你的胰臟 (電影珍藏版)",
    "看不見的訪客", "媽媽的彩虹", "麻吉萬歲", "倒楣鬼的日記", "小兵兒童#56香腸班長當家", "小兵兒童#57ㄒㄧㄚˋ老師的秘密武器", "氣泡人", "漾少年YOUNG02-迪藍的星星", "嘟嘟減肥記", "路燈阿亮亮亮亮", "草莓讀心術", "感動一輩子的親情小故事", "從漫畫裡跳出來的男孩", "折翼天使", "加油!俏ㄚ頭", "瞧，這群俏ㄚ頭", "叔的秘密情人", "海馬爸爸", "我媽媽是虎姑婆", "只丟下我一個人", "卡蘭德文件", "我的麗莎阿姨", "走了一個小偷之後", "變身魔法石", "我們這一班", "只要我長大", "冒牌爸爸", "會笑的陽光", "我和我的家人們", "為天量身高", "孩子一定要讀的寓言故事", "聖誕老公公不見了", "貪心的小企鵝", "野蠻丫頭戴安", "空箱子(新版)", "靈靈精精精靈靈", "魔法小象小朋友", "愛在蔓延中", "我的名字叫希望", "維京小英雄-如何馴服你的龍", "我贏了! 我贏了!(三書)", "手心裡的祝福", "歐麥加的狗日子Oh-My God!", "杯子蛋糕的魔力", "討厭魔法的小魔女", "霍爾姆鎮的大秘密", "我的貝殼借妳玩", "慢慢龜變勇敢了", "奧莉薇亞的水中屋"
  ];
