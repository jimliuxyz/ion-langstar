...
import { BookInfo, BookType, BookData_MCQ, BookDataCfg_MCQ, BookData } from '../../define/book';
...
import { AppQuizService, SYM } from '../../app/app-service/app.quiz.service';
...
export class EditorPage {
  ...
  private bookinfo$: ReplaySubject<BookInfo>;
  
  data: any[];
  setting: BookInfo = <BookInfo>{};
  protected dirty = false;

  private btnarr: string[][] = [
  ...
  protected openModal(cmd: string) {
    let modal = this.modalCtrl.create(SettingComponent, { bookuid:this.bookuid });
    modal.present();
  }
